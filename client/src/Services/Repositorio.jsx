...
<div className='mx-8 my-12 sm:mx-8 sm:my-16 md:mx-12 md:my-20 lg:mx-28 lg:my-20 max-w-screen-xl'>
  <div className="flex flex-col md:flex-row">
    <div className='w-full md:w-1/2 pr-7'>
      <h1 className="font-anton text-2xl text-cc mb-8 w-96">https://www.youtube.com/@AntivirusparalaDesercion/videos
      </h1>
      ...
      Link / Canal youtube</h2>
      <p className='text-blue-links text-lg'>
      Es un espacio digital académico, de diferentes materias, disponibles para la consulta en Youtube.
    ...
    <div className='w-full md:w-1/2 relative'>
      <img src={foto3} alt="emocional 1" className="w-full h-auto object-cover" />
{/* 
...
<img className="w-full h-auto object-cover" src={foto4} alt="emocional 2" />
