    ...
    <div>
       <header onMouseLeave={handleMouseLeave} className={`hidden z-50 flex lg:flex justify-between items-center py-3 px-16 max-md:py-2 bg-white fixed w-full transition-all duration-300 ${isHidden ? '-translate-y-full' : 'translate-y-0'}`}>
            <div className='Links-left flex gap-1 items-center'>
                <Link to="/" onClick={handleNav} className='text-lg text-title font-extrabold uppercase transition duration-400 ease-in-out max-xl:text-sm object-contain' style={{ letterSpacing: '-1px', fontFamily: 'Acumin2' }}>Inicio</Link>
                <span className='text-blue-links mx-1'>|</span>
                <Link to="/Fundacion" className='text-lg text-title font-extrabold uppercase leading-none transition duration-400 ease-in-out max-xl:text-sm' style={{ letterSpacing: '-1px', fontFamily: 'Acumin2' }}>FUNDACIÓN</Link>
                <span className='text-title mx-1'>|</span>
                <button onClick={handleClikPopupQH} className='flex items-center text-lg text-title font-extrabold uppercase leading-none transition duration-400 ease-in-out max-xl:text-sm' style={{ letterSpacing: '-1px', fontFamily: 'Acumin2' }}>QUÉ HACEMOS</button>
                <span className='text-title mx-1'>|</span>
                <button onClick={handleClikPopupServices} className='text-lg text-title font-extrabold uppercase leading-none transition duration-400 ease-in-out max-xl:text-sm' style={{ letterSpacing: '-1px', fontFamily: 'Acumin2' }}>SERVICIOS</button>
            </div>
            ...
            <div className='Links-right flex gap-3 items-center'>
                <Link to="/Proyectos" className='text-lg text-title font-extrabold uppercase leading-none transition duration-400 ease-in-out max-xl:text-sm' style={{ letterSpacing: '-1px', fontFamily: 'Acumin2' }}>Proyectos</Link>
                <span className='text-title mx-1'>|</span>
                <Link to="/ContactUs" className='text-lg text-title font-extrabold uppercase leading-none transition duration-400 ease-in-out max-xl:text-sm' style={{ letterSpacing: '-1px', fontFamily: 'Acumin2' }}>CONTÁCTENOS</Link>
                <span className='text-title mx-1'>|</span>
                <button onClick={handleClikPopupIdioma} className='flex items-center justify-center text-lg text-title font-extrabold uppercase leading-none transition duration-400 ease-in-out' style={{ letterSpacing: '-1px', fontFamily: 'Acumin2' }}>
                    ESP
                ...
                <button className='flex items-center justify-center py-3 px-4 bg-btn-back rounded-3xl text-white font-bold hover:bg-orange-500 transition duration-700 transform hover:scale-105 max-xl:py-2 px-3' style={{ fontFamily: 'Acumin2' }}>
