...
const ServicesATV = () => {
  ...
  return (
    <div>
      <div className='flex flex-col bg-content w-5/4 md:flex-row md:gap-96 text-white tracking-tighter text-xl'>
      ...
      <div className='md:w-1/2 '>
        <div className='flex gap-16 items-center justify-center md:max-w-full md:h-auto md:flex-col md:gap-6' style={{ width: '100%', height: '100%', transform: `translateX(-50%)` }}>
          {imgs.map((logo, index) => (
            <div key={index} className={`w-full h-full ${index === startIndex ? '' : 'hidden'}`}>
              <div style={{ width: '150%', height: '100%', overflow: 'hidden' }}>
                <img
                  src={logo}
                  alt={`Logo ${index}`}
    ...
    <div className="containerBtnServ flex flex-row justify-end">
      <div className='flex justify-end'>
        <div className='flex bg-content w-96 h-40 flex-col justify-center text-center'>
      ...
      <div className="btn_Serv flex justify-end">
          ...
          <button className='btnLeft px-14'>
          ...
          <button className='btnRigth px-14'>
            <svg xmlns="http://www.w3.org/2000/svg" width="15" height="15" viewBox="0 0 15 15" fill="none">
