...
function OurAllies() {
  ...
  return (
    <>
    <h1 className='mt-20 mb-20 text-center text-5xl text-title font-extrabold'>NUESTROS ALIADOS</h1>
    <div className='mt-14 mb-14 flex gap-16 items-center justify-center max-md:gap-4 max-lg:gap-3'>
